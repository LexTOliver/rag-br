# Links para execução no Google Colab

## 01 – Data Understanding  
- [`notebooks/01_data_understanding.ipynb`](../../notebooks/01_data_understanding.ipynb)
- [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1VIwDCIj34QuRYoCelLkT57dHwy4Sts2F?usp=sharing)
...
## 04 – Train Reranker (TODO)
- `notebooks/04_train_reranker.ipynb`  
Colab: **TODO**
...
## 06 – RAG Pipeline Tests (TODO)
- `notebooks/06_rag_pipeline_tests.ipynb`  
Colab: **TODO**
